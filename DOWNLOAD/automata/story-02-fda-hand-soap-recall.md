...
**Before assuming you are safe, check the specific lot code on your bottle**, not just the brand name. The FDA enforcement record, posted September 11, 2026, contains the definitive list of affected UPC codes and lot identifiers. Go to the FDA's recall database directly and search for the Intercon Chemical recall to verify your specific product. Brand name alone is not sufficient — the recall covers specific production runs, not the entire product line.

## What Class II Recall Means

An FDA Class II recall indicates that exposure to the contaminated product may cause temporary or medically reversible health problems, with a remote chance of serious illness in healthy individuals. The risk level is higher for vulnerable groups.

*Pseudomonas aeruginosa*, the primary organism of concern, is an opportunistic bacterium. It does not typically cause problems when it contacts intact healthy skin. The risk rises significantly when it enters through a cut, break, or abrasion — which makes a hand soap an unusually direct exposure route. Washing hands over a wound with a contaminated soap delivers bacteria directly to the entry point. In clinical settings, *Pseudomonas aeruginosa* is one of the most common causes of hospital-acquired infections.
...
This is not unusual in the FDA recall process. Manufacturers often initiate voluntary recalls before formal FDA classification; the classification is a separate administrative step. But the practical consequence here is that contaminated bottles have been in active use in household bathrooms for months without a formal public health alert.
...
**Which hand soaps are being recalled by the FDA?**
Six foaming hand soaps manufactured by Intercon Chemical Company of St. Louis, Missouri. The retail consumer product is Laura Lynn brand (pear and apple-scented), sold at Ingles Markets in the Southeast. The others are commercial dispenser refills under the Clearly Better, Vestis, and Summit 150 brands. The recall covers 15 US states.

**What does an FDA Class II recall mean for soap?**
...
**Length used:** 820 words. The topic requires explanation of the Class II classification, the specific risk mechanism, the lot-code verification step, and disposal instructions. A shorter article would leave readers without the actionable information needed to protect themselves.

**Traffic and earnings audit:**
- Consequence paragraph present and placed before depth block: ✓
- Minimum 2 internal links (placeholders: home sanitization guide, consumer protection guide): ✓ — flagged for editor to insert live URLs
- US angle explicit (Southeast US, Ingles Markets, 15 states): ✓
- Priority PAA answered in FAQ section: ✓
- Primary keyword "hand soap recall 2026" in headline variant, opening 100 words, subheading: ✓
- Return visitor trigger in closure: ✓

**Fact audit:**
- Six products recalled: confirmed (Stage 1a, FDA enforcement record September 11, 2026)
- Manufacturer: Intercon Chemical Company, St. Louis, MO: confirmed
- Bacteria identified: *Pseudomonas aeruginosa*, *P. putida*, *P. monteilii*, *Serratia marcescens*, *S. nematodiphila*: confirmed
- Class II classification date: September 11, 2026: confirmed
- Voluntary recall start: June 29, 2026: confirmed
- Laura Lynn brand at Ingles Markets: confirmed (Stage 1a gap analysis)
- Expiration dates to March 2028: confirmed (Stage 1a)
- 15 states: confirmed
- Pseudomonas aeruginosa hospital-acquired infection risk: confirmed standard clinical knowledge, not from primary recall document — flagged as background context
- Pink/reddish biofilm from Serratia marcescens: confirmed standard microbiological characteristic
- Specific UPC codes: NOT listed in article — directed readers to FDA database for verification (correct approach given inability to verify complete list)

**Final factual version:** Article as written. UPC codes not listed directly; readers directed to FDA source for verification.

**Meta description:** Six hand soaps were recalled across 15 states over bacterial contamination concerns. Check product and lot details — especially Laura Lynn brand at Ingles Markets — before using affected soap.

**Social headline:** Check Your Sink: Popular Hand Soaps Recalled Across 15 States Over Infection Risks
