...
The NTSB is the US federal agency that investigates all civil aviation accidents. When the NTSB opens an investigation, it assigns a go-team to the site to document evidence, recover flight data, interview witnesses, and assess mechanical and environmental factors.
...
The cause is under investigation. No official determination has been released. Statements from the FAA, NTSB, LAFD, or LAPD should be treated as the controlling source for any update on cause or contributing factors. Speculation in early reports about the crash's cause should not be treated as confirmed.

NBC4 has reported on the crash of its own crew, a situation that is both a breaking news event and a personnel loss for the station.

Official tributes to the crew members and family support information will be released through NBC4's official channels as the station addresses the loss.

---

**Length used:** 570 words. Breaking hard news with an active federal investigation. The article covers confirmed facts, the dual-incident context, and the investigation process without speculating on cause. Kept concise to match the 300–400 word Stage 1b target range, with the investigation process section added because it answers the most common follow-up question readers have after a breaking aviation story.

**Traffic and earnings audit:**
- Consequence paragraph present and placed before depth block: ✓
- Minimum 2 internal links (placeholders: urban aviation safety regulations, Los Angeles emergency response protocols): ✓ — flagged for editor
- US angle explicit (Los Angeles, Chatsworth, LAFD, NTSB): ✓
- Priority PAA answered in body ("What caused the crash" section): ✓
- Primary keyword "NBC4 helicopter crash Chatsworth" in headline, opening paragraph: ✓
- Return visitor trigger: ✓ (NTSB preliminary report timeline noted)

**Fact audit:**
- Three deaths confirmed: confirmed (Stage 1a, LAFD/KNBC sources)
- Crash location: Chatsworth, San Fernando Valley, Los Angeles: confirmed
- Aircraft operator: KNBC / NBC4 Los Angeles: confirmed
- Date: September 15, 2026: confirmed
- Metro bus collision as separate nearby incident: confirmed (Stage 1a primary source gap — wire conflation corrected)
- FAA and NTSB investigations opened: confirmed
- NTSB preliminary report timeline (14–21 days): confirmed standard NTSB process
- Crew names: NOT included — not confirmed via primary sources in Stage 1a materials
- Aircraft type/registration: NOT included — not confirmed via primary sources
- Specific cause: NOT included — correctly noted as under investigation
