---
title: "UPI Tax Bill Introduced: Payment System Faces Levy While Modi Claims 'Remains Free'"
author: "Sunita"
date: 2026-08-11
categories: [Fiscal Policy, Financial Technology, India]
word_count: 1750
sources:
  - Finance Minister Nirmala Sitharaman Statement
  - Taxation and Other Laws Amendment Bill 2026
  - Reserve Bank of India Position
  - NPCI (National Payments Corporation of India) Analysis
  - Opposition Parliamentary Records
---

# UPI Tax Bill Introduced: Payment System Faces Levy While Modi Claims 'Remains Free'

The government introduced the Taxation and Other Laws Amendment Bill 2026 to Parliament in early August. One provision amends the Payment Settlement Systems (PSS) Act 2007, establishing a taxation framework for payment transaction networks. This amendment is targeted at UPI—India's Unified Payments Interface.

UPI processes nearly 10 billion transactions monthly, making it one of the world's largest real-time payment systems. The system has been free to users and merchants since its launch in 2016. The proposed amendment leaves open questions about who will bear the new tax burden and whether "free" retains meaning if the system is taxed.

Finance Minister Nirmala Sitharaman stated: "UPI remains free." She clarified: "The vast majority of merchant transactions would remain free." These statements are precise. They avoid saying that UPI itself is tax-free; they assert that transactions would "remain free"—a distinction that requires unpacking.
...
1. Establish a specific tax rate or method
2. Define which transactions are taxable
...
Sitharaman's statement that "UPI remains free" is strategically worded. Free to whom? For what purpose?

If the tax applies to merchants rather than end users, consumers sending money via UPI would pay nothing—transactions remain free. The merchant bears the cost. This aligns with Sitharaman's statement.
...
Merchant taxes are economic distortions. If the tax applies to merchants accepting UPI payments, merchants bear the cost. How merchants respond depends on the tax rate:

- **Absorption**: Merchants absorb the cost to avoid raising prices and losing customers
- **Pass-through**: Merchants raise prices on consumers, shifting the cost forward
- **Avoidance**: Merchants reduce UPI usage and revert to cash or card payments
...
- **Regressive impact**: UPI usage is highest among lower-income users, so a UPI tax disproportionately affects those with less capacity to pay
- **Contradiction**: The government promoted UPI as part of digital India and financial inclusion; taxing it undermines that agenda
...
- Slower UPI growth trajectory
- Increased cash usage, reducing digital transaction rates
- Pressure on merchant margins and retail pricing
- Potential systemic risk if merchants or users flee to informal or unregulated alternatives

## NPCI's Role and Operational Implications

NPCI (National Payments Corporation of India) operates UPI on behalf of the Reserve Bank. NPCI's costs are borne by member banks and funded through transaction volumes.
...
## Comparison to GST and International Models
...
The CPI(M) and AAP's opposition can be understood through specific lenses:

1. **Equity**: UPI taxation is regressive—it disproportionately affects lower-income users
2. **Digital inclusion**: Taxing a foundational digital infrastructure contradicts the Digital India objective
...
The Taxation and Other Laws Amendment Bill 2026, specifically its Section 10A amendment to the PSS Act, introduces taxation of UPI transaction networks for the first time. Finance Minister Sitharaman's assurance that "UPI remains free" is precise in language but masks uncertainty about the tax's actual incidence—who bears the cost and how it affects UPI usage and transaction volumes.

The amendment's introduction sparked opposition parliamentary walkouts and criticism from the fintech industry and digital payment advocates. Questions remain: Will the tax apply to consumers, merchants, or infrastructure operators? At what rate? With what exemptions? How will it affect the growth trajectory of digital payments in India?

The bill's passage will depend on parliamentary debate and committee scrutiny. The economic impact will depend on the final tax rate, exemptions, and how merchants and users respond. The government's framing of UPI as "remaining free" suggests an attempt to manage public perception of a tax that most people understand as contrary to UPI's historical promise of free, universal digital payments.
